...
set_input_delay 3.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {user_clock2}]
...
set_output_delay 3.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {user_irq[0]}]
set_output_delay 3.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {user_irq[1]}]
set_output_delay 3.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {user_irq[2]}]
